...
if (isset($_POST['submit'])) {
    ...
    $shippingInfo['address_nick'] = sanitizeInput($_POST['address_nick']);
    $shippingInfo['companyName'] = sanitizeInput($_POST['companyName']);
    $shippingInfo['title'] = sanitizeInput($_POST['title']);
    $shippingInfo['firstName'] = sanitizeInput($_POST['firstName']);
    $shippingInfo['lastName'] = sanitizeInput($_POST['lastName']);
    $shippingInfo['address1'] = sanitizeInput($_POST['address1']);
    $shippingInfo['city'] = sanitizeInput($_POST['city']);
    $shippingInfo['country'] = sanitizeInput($_POST['country']);
    $shippingInfo['state'] = sanitizeInput($_POST['state']);
    $shippingInfo['email'] = sanitizeInput($_POST['email']);
    $shippingInfo['phone'] = sanitizeInput($_POST['phone']);
...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
    <div class="container-xxl">
      ...
      <div class="collapse navbar-collapse justify-content-end align-center" id="main-nav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="<?php echo SITEURL; ?>screen/_store.php">SHOP</a>
          </li>
          <li class="nav-item">
    ...
    <div class="container">
        ...
        <p class="lead fw-bold text-center">Add/Edit Shipping Info</p>
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6 col-md-6">
                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                    <div class="mb-3">
                        <label for="address_nick" class="fw-bold">Address Nick Name*</label>
                        <input type="text" class="form-control ms-3 me-5" id="address_nick" name="address_nick"
                        value="<?php echo isset($shippingInfo['address_nick']) ? $shippingInfo['address_nick'] : ''; ?>"
                        required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php echo isset($shippingInfo['companyName']) ? $shippingInfo['companyName'] : ''; ?>"
                        required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control ms-3" id="title" name="title">
                            ...
                            <option value="Mr" <?php if (isset($shippingInfo['title']) && $shippingInfo['title'] == 'Mr') echo 'selected'; ?>>Mr</option>
                            <option value="Mrs"  <?php if (isset($shippingInfo['title']) && $shippingInfo['title'] == 'Mrs') echo 'selected'; ?>>Mrs</option>
                        </select>
                    </div>
                    ...
                    <div class="mb-3">
                        <label for="address1" class="fw-bold">Address1*</label>
                        <input type="text" class="form-control ms-3" id="address1" name="address1" 
                        value="<?php echo isset($shippingInfo['address1']) ? $shippingInfo['address1'] : ''; ?>"
                        required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control ms-3" id="country" name="country" required>
                            ...
                            <optgroup label="Country">
                                ...
                                <?php if (isset($shippingInfo['country']) && $shippingInfo['country'] == 'Ethiopia') echo 'selected'; ?>>Ethiopia</option>
                                <option value="United States" <?php if (isset($shippingInfo['country']) && $shippingInfo['country'] == 'United States') echo 'selected'; ?>>United States</option>
    ...
    <?php echo isset($shippingInfo['country']) ? '' : 'disabled'; ?> required>
    <option value="" selected disabled>-- Select --</option>

    <?php
    if (isset($shippingInfo['country']) && isset($stateOptions[$shippingInfo['country']])) {
        foreach ($stateOptions[$shippingInfo['country']] as $state) {
            echo '<option value="' . $state . '" ' . ((isset($shippingInfo['state']) && $shippingInfo['state'] == $state) ? 'selected' : '') . '>' . $state . '</option>';
        }
    }
    ?>
</select>
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php echo isset($shippingInfo['email']) ? $shippingInfo['email'] : ''; ?>"
                        required>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        value="<?php echo isset($shippingInfo['phone']) ? $shippingInfo['phone'] : ''; ?>" 
                        required>
                    </div>
